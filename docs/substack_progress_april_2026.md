...
- **Hallucination signal.** On TruthfulQA, the bifurcation index has AUROC 0.57 for separating true from false answers — modest, but present, and from a feature the model wasn't trained to compute.
