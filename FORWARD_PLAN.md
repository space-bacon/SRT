...
| **Cross-vendor portability** | Image agreement across four vendors r@1 0.8024 vs 0.0007 floor, on ROCO radiology images (C2). Caption head confirmed as the shared bottleneck by head swap: a distinct off-the-shelf tower per vendor raises within by ×1.21 and cross by ×1.23, gap over sd −0.51 (C60). | `main` | Live: `srt-omni-demo`, states published. The caption head at 0.1050 is the bottleneck. |
