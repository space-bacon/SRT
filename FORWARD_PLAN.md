...
| **Cross-vendor portability** | Image agreement across four vendors r@1 0.8024 vs 0.0007 floor, on ROCO radiology images (C2). Caption head confirmed as the shared bottleneck by head swap: within scales 0.938, cross 0.973. | `main` | Live: `srt-omni-demo`, states published. The caption head at 0.1050 is the bottleneck. |
